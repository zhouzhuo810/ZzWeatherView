...
public class ZzWeatherView extends HorizontalScrollView {
     ...
     * @param data 天气数据
     */
    public void setData(final List<WeatherModel> data) {
        this.mData = data;
        int screenWidth = getScreenWidth();
        int maxDay = getMaxDayTemp(data);
        int maxNight = getMaxNightTemp(data);
        int minDay = getMinDayTemp(data);
        int minNight = getMinNightTemp(data);
            ...
            itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (weatherItemClickListener != null) {
                        weatherItemClickListener.onItemClick(itemView, finalI, data.get(finalI));
                    }
                }
            });
